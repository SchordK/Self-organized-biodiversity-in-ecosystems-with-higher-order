...
databifurcation1(k,2*i-1)=mu2;
databifurcation1(k,2*i)=pkx1(k);
end
% xlabel('\fontname{Times New Roman}\fontsize{24}\it{mu2}');
...
plot(abs(databifurcation25(:,2*l-1)),databifurcation25(:,2*l),'.b','markersize',10);
end
xlabel('\fontname{Times New Roman}\fontsize{24}\it{mu2}');
ylabel('\fontname{Times New Roman}\fontsize{24}{Max(\it{N_10})}');
set(gca,'FontName','Times New Roman','FontSize',24,'linewidth',1.5);
